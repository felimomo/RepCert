...
cd ../../replab-0.9.0;
replab_init
mkdir ../RepCert/ForTesting/S10wrS10;
cd ../RepCert/ForTesting/S10wrS10;
...
% build group
% Parties = replab.S(5) 
Settings= replab.S(10) 
Outcomes= replab.S(10)
...
rep= W.imprimitiveRep(Outcomes.naturalRep);%for double products
